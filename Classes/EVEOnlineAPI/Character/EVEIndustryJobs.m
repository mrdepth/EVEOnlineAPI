...
- (id) initWithXMLAttributes:(NSDictionary *)attributeDict {
	if (self = [super init]) {
		...
		self.containerID = [[attributeDict valueForKey:@"containerID"] integerValue];
		self.installedItemID = [[attributeDict valueForKey:@"installedItemID"] longLongValue];
		self.installedItemLocationID = [[attributeDict valueForKey:@"installedItemLocationID"] integerValue];
		...
		self.outputLocationID = [[attributeDict valueForKey:@"outputLocationID"] integerValue];
		self.installerID = [[attributeDict valueForKey:@"installerID"] integerValue];
