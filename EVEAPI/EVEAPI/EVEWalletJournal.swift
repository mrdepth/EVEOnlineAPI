...
public class EVEWalletJournalItem: EVEObject {
	...
	override public func scheme() -> [String:EVESchemeElementType] {
		...
		"ownerID1":EVESchemeElementType.Int64(elementName:nil, transformer:nil),
		"ownerName2":EVESchemeElementType.String(elementName:nil, transformer:nil),
		"ownerID2":EVESchemeElementType.Int64(elementName:nil, transformer:nil),
		"argName1":EVESchemeElementType.String(elementName:nil, transformer:nil),
		"argID1":EVESchemeElementType.Int64(elementName:nil, transformer:nil),
		...
		"taxReceiverID":EVESchemeElementType.Int64(elementName:nil, transformer:nil),
