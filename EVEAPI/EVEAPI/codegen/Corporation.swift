...
extension ESI {
	...
	public struct Corporation {
		...
		public func getCorporationIssuedMedals(corporationID: Int, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDMedalsIssuedOk], AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_medals.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/medals/issued/")
		...
		public func getCorporationMemberLimit(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<Int, AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.track_members.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/members/limit/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationInformation(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<Corporation.Information, AFError> {
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationStandings(corporationID: Int, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDStandingsOk], AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_standings.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/standings/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getStarbasePOSDetail(corporationID: Int, starbaseID: Int64, systemID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<Corporation.GetCorporationsCorporationIDStarbasesStarbaseIDOk, AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_starbases.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			query.append(URLQueryItem(name: "system_id", value: systemID.description))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/starbases/\(starbaseID)/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationStarbasesPOSes(corporationID: Int, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDStarbasesOk], AFError> {
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/starbases/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationMembers(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Int], AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_corporation_membership.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/members/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationTitles(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDTitlesOk], AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_titles.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/titles/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getAllianceHistory(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.History], AFError> {
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/alliancehistory/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationMemberRoles(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.Role], AFError> {
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/roles/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getNpcCorporations(cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Int], AFError> {
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/npccorps/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationBlueprints(corporationID: Int, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDBlueprintsOk], AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_blueprints.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/blueprints/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func trackCorporationMembers(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDMembertrackingOk], AFError> {
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/membertracking/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationsMembersTitles(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDMembersTitlesOk], AFError> {
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/members/titles/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationStructures(acceptLanguage: AcceptLanguage? = nil, corporationID: Int, language: Language? = nil, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.Structure], AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_structures.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/structures/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getAllCorporationALSCLogs(corporationID: Int, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDContainersLogsOk], AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_container_logs.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/containers/logs/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationMemberRolesHistory(corporationID: Int, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDRolesHistoryOk], AFError> {
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/roles/history/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationFacilities(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDFacilitiesOk], AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_facilities.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/facilities/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationMedals(corporationID: Int, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDMedalsOk], AFError> {
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/medals/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationIcon(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<Corporation.Icon, AFError> {
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/icons/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationDivisions(corporationID: Int, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<Corporation.Divisions, AFError> {
			
			let scopes = esi.token?.scopes ?? []
			guard scopes.contains("esi-corporations.read_divisions.v1") else {return Fail(error: AFError.createURLRequestFailed(error: ESIError.forbidden)).eraseToAnyPublisher()}
			let body: Data? = nil
			...
			query.append(URLQueryItem(name: "datasource", value: esi.server.rawValue))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/divisions/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public func getCorporationShareholders(corporationID: Int, page: Int? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy) -> AnyPublisher<[Corporation.GetCorporationsCorporationIDShareholdersOk], AFError> {
			...
			if let v = page?.description {
				query.append(URLQueryItem(name: "page", value: v.lazy.map{$0.description}.joined(separator: ",")))
			        ...
			        let url = ESI.apiURL.appendingPathComponent("/corporations/\(corporationID)/shareholders/")
			var components = URLComponents(url: url, resolvingAgainstBaseURL: false)!
			components.queryItems = query
		...
		public struct Information: Codable, Hashable {
			...
			public init(allianceID: Int?, ceoID: Int, creatorID: Int, dateFounded: Date?, localizedDescription: String?, factionID: Int?, homeStationID: Int?, memberCount: Int, name: String, shares: Int64?, taxRate: Float, ticker: String, url: String?, warEligible: Bool?) {
		...
		public struct Role: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDRolesGrantableRolesAtHq: String, Codable, CustomStringConvertible {
			...
			public enum GetCorporationsCorporationIDRolesRolesAtOther: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDRolesRoles: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDRolesGrantableRolesAtBase: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDRolesGrantableRolesAtOther: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDRolesRolesAtBase: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDRolesGrantableRoles: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDRolesRolesAtHq: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
		...
		public struct GetCorporationsCorporationIDMedalsIssuedOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDMedalsIssuedStatus: String, Codable, CustomStringConvertible {
		...
		public struct GetCorporationsCorporationIDBlueprintsOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDBlueprintsLocationFlag: String, Codable, CustomStringConvertible {
		...
		public struct Structure: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDStructuresState: String, Codable, CustomStringConvertible {
			...
			public struct GetCorporationsCorporationIDStructuresServices: Codable, Hashable {
				...
				public enum GetCorporationsCorporationIDStructuresServiceState: String, Codable, CustomStringConvertible {
		...
		public struct GetCorporationsCorporationIDContainersLogsOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDContainersLogsPasswordType: String, Codable, CustomStringConvertible {
				case config = "config"
			...
			public enum GetCorporationsCorporationIDContainersLogsAction: String, Codable, CustomStringConvertible {
				case add = "add"
			...
			public enum GetCorporationsCorporationIDContainersLogsLocationFlag: String, Codable, CustomStringConvertible {
				case assetSafety = "AssetSafety"
				case autoFit = "AutoFit"
				case bonus = "Bonus"
				case booster = "Booster"
		...
		public struct GetCorporationsCorporationIDStarbasesStarbaseIDOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDStarbasesStarbaseIDAnchor: String, Codable, CustomStringConvertible {
			...
			public enum GetCorporationsCorporationIDStarbasesStarbaseIDOffline: String, Codable, CustomStringConvertible {
				case allianceMember = "alliance_member"
				case configStarbaseEquipmentRole = "config_starbase_equipment_role"
				case corporationMember = "corporation_member"
				case starbaseFuelTechnicianRole = "starbase_fuel_technician_role"
			...
			public enum GetCorporationsCorporationIDStarbasesStarbaseIDFuelBayTake: String, Codable, CustomStringConvertible {
				case allianceMember = "alliance_member"
				case configStarbaseEquipmentRole = "config_starbase_equipment_role"
				case corporationMember = "corporation_member"
				case starbaseFuelTechnicianRole = "starbase_fuel_technician_role"
			...
			public enum GetCorporationsCorporationIDStarbasesStarbaseIDOnline: String, Codable, CustomStringConvertible {
				case allianceMember = "alliance_member"
				case configStarbaseEquipmentRole = "config_starbase_equipment_role"
				case corporationMember = "corporation_member"
				case starbaseFuelTechnicianRole = "starbase_fuel_technician_role"
			...
			public enum GetCorporationsCorporationIDStarbasesStarbaseIDFuelBayView: String, Codable, CustomStringConvertible {
				case allianceMember = "alliance_member"
				case configStarbaseEquipmentRole = "config_starbase_equipment_role"
				case corporationMember = "corporation_member"
				case starbaseFuelTechnicianRole = "starbase_fuel_technician_role"
			...
			public enum GetCorporationsCorporationIDStarbasesStarbaseIDUnanchor: String, Codable, CustomStringConvertible {
				case allianceMember = "alliance_member"
				case configStarbaseEquipmentRole = "config_starbase_equipment_role"
				case corporationMember = "corporation_member"
				case starbaseFuelTechnicianRole = "starbase_fuel_technician_role"
		...
		public struct GetCorporationsCorporationIDStandingsOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDStandingsFromType: String, Codable, CustomStringConvertible {
				case agent = "agent"
		...
		public struct GetCorporationsCorporationIDStarbasesOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDStarbasesState: String, Codable, CustomStringConvertible {
				case offline = "offline"
				case online = "online"
		...
		public struct GetCorporationsCorporationIDTitlesOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDTitlesRolesAtBase: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDTitlesGrantableRolesAtHq: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDTitlesRolesAtOther: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDTitlesGrantableRolesAtOther: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDTitlesGrantableRoles: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDTitlesRolesAtHq: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDTitlesRoles: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDTitlesGrantableRolesAtBase: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
		...
		public struct GetCorporationsCorporationIDRolesHistoryOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDRolesHistoryOldRoles: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDRolesHistoryNewRoles: String, Codable, CustomStringConvertible {
				case accountTake1 = "Account_Take_1"
				case accountTake2 = "Account_Take_2"
				case accountTake3 = "Account_Take_3"
				case accountTake4 = "Account_Take_4"
			...
			public enum GetCorporationsCorporationIDRolesHistoryRoleType: String, Codable, CustomStringConvertible {
				case grantableRoles = "grantable_roles"
				case grantableRolesAtBase = "grantable_roles_at_base"
				case grantableRolesAtHq = "grantable_roles_at_hq"
				case grantableRolesAtOther = "grantable_roles_at_other"
		...
		public struct GetCorporationsCorporationIDShareholdersOk: Codable, Hashable {
			...
			public enum GetCorporationsCorporationIDShareholdersShareholderType: String, Codable, CustomStringConvertible {
