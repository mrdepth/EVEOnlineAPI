	...
	public struct Killmails {
		...
		public struct KillmailID {
			...
			public struct KillmailHash {
				...
				public func get(cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<ESI.Killmails.KillmailID.KillmailHash.Success>, AFError> {
					do {
