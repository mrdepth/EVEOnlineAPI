...
extension ESI {
	...
	public struct Fleets {
		...
		public struct FleetID {
			...
			public func get(cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<ESI.Fleets.FleetID.Success>, AFError> {
				do {
					...
					return Deferred { () -> AnyPublisher<ESIResponse<ESI.Fleets.FleetID.Success>, AFError> in
			...
			public func put(newSettings: ESI.Fleets.FleetID.NewSettings, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<Void>, AFError> {
				do {
			...
			public struct Members {
				...
				public func get(language: ESI.Corporations.Language? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<[ESI.Fleets.FleetID.Members.Success]>, AFError> {
					do {
						...
						return Deferred { () -> AnyPublisher<ESIResponse<[ESI.Fleets.FleetID.Members.Success]>, AFError> in
							var request = session.request(components, method: .get, encoding: URLEncoding.default, headers: headers, interceptor: CachePolicyAdapter(cachePolicy: cachePolicy))
				...
				public func post(invitation: ESI.Fleets.FleetID.Members.Invitation, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<Void>, AFError> {
					do {
				...
				public struct MemberID {
					...
					public func put(movement: ESI.Fleets.FleetID.Members.MemberID.Movement, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<Void>, AFError> {
						do {
			...
			public struct Squads {
				...
				public struct SquadID {
					...
					public func put(naming: ESI.Fleets.FleetID.Naming, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<Void>, AFError> {
						do {
			...
			public struct Wings {
				...
				public func get(language: ESI.Corporations.Language? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<[ESI.Fleets.FleetID.Wings.Success]>, AFError> {
					do {
						...
						return Deferred { () -> AnyPublisher<ESIResponse<[ESI.Fleets.FleetID.Wings.Success]>, AFError> in
							var request = session.request(components, method: .get, encoding: URLEncoding.default, headers: headers, interceptor: CachePolicyAdapter(cachePolicy: cachePolicy))
				...
				public func post(cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<ESI.Fleets.FleetID.Wings.Created>, AFError> {
					do {
						...
						return Deferred { () -> AnyPublisher<ESIResponse<ESI.Fleets.FleetID.Wings.Created>, AFError> in
				...
				public struct WingID {
					...
					public struct Squads {
						...
						public func post(cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<ESI.Fleets.FleetID.Wings.WingID.Squads.Created>, AFError> {
							do {
								...
								return Deferred { () -> AnyPublisher<ESIResponse<ESI.Fleets.FleetID.Wings.WingID.Squads.Created>, AFError> in
									var request = session.request(components, method: .post, encoding: URLEncoding.default, headers: headers, interceptor: CachePolicyAdapter(cachePolicy: cachePolicy))
