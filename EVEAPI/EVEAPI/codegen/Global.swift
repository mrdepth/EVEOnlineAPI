...
public extension ESI {
	...
	class func loadClassess() {
		...
		_ = FactionWarfare.GetFwStatsOk.GetFwStatsVictoryPoints.classForCoder()
		...
		_ = FactionWarfare.GetFwWarsOk.classForCoder()
		...
		_ = FactionWarfare.GetFwStatsOk.GetFwStatsKills.classForCoder()
		...
		_ = FactionWarfare.GetFwStatsOk.classForCoder()
