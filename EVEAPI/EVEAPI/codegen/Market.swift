...
public extension ESI {
	...
	class Market {
		...
		public func listHistoricalOrdersByCharacter(characterID: Int, page: Int? = nil, completionBlock:((Result<[Market.GetCharactersCharacterIDOrdersHistoryOk]>) -> Void)?) {
			var session = sessionManager
			guard session != nil else {return}
		...
		public func listOpenOrdersFromCorporation(corporationID: Int, page: Int? = nil, completionBlock:((Result<[Market.GetCorporationsCorporationIDOrdersOk]>) -> Void)?) {
			var session = sessionManager
			guard session != nil else {return}
		...
		public func listHistoricalOrdersFromCorporation(corporationID: Int, page: Int? = nil, completionBlock:((Result<[Market.GetCorporationsCorporationIDOrdersHistoryOk]>) -> Void)?) {
			var session = sessionManager
			guard session != nil else {return}
		...
		public func listOpenOrdersFromCharacter(characterID: Int, completionBlock:((Result<[Market.CharacterOrder]>) -> Void)?) {
			var session = sessionManager
			guard session != nil else {return}
