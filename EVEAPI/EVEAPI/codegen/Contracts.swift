...
public extension ESI {
	...
	class Contracts {
		...
		public func getCorporationContractItems(contractID: Int, corporationID: Int, completionBlock:((Result<[Contracts.GetCorporationsCorporationIDContractsContractIDItemsOk]>) -> Void)?) {
			var session = sessionManager
			guard session != nil else {return}
			
			let scopes = (session?.adapter as? OAuth2Adapter)?.token.scopes ?? []
			guard scopes.contains("esi-contracts.read_corporation_contracts.v1") else {completionBlock?(.failure(ESIError.forbidden)); return}
		...
		public func getCoporationContracts(corporationID: Int, completionBlock:((Result<[Contracts.GetCorporationsCorporationIDContractsOk]>) -> Void)?) {
			var session = sessionManager
			guard session != nil else {return}
		...
		public func getCorporationContractBids(contractID: Int, corporationID: Int, page: Int? = nil, completionBlock:((Result<[Contracts.GetCorporationsCorporationIDContractsContractIDBidsOk]>) -> Void)?) {
			var session = sessionManager
			guard session != nil else {return}
		...
		@objc(ESIContractsContract) public class Contract: NSObject, NSSecureCoding, NSCopying, JSONCoding {
			...
			public var buyout: Double? = nil
			public var collateral: Double? = nil
			...
			public required init(json: Any) throws {
				...
				buyout = dictionary["buyout"] as? Double
				collateral = dictionary["collateral"] as? Double
				...
				reward = dictionary["reward"] as? Double
			...
			public required init?(coder aDecoder: NSCoder) {
				...
				buyout = aDecoder.containsValue(forKey: "buyout") ? aDecoder.decodeDouble(forKey: "buyout") : nil
				collateral = aDecoder.containsValue(forKey: "collateral") ? aDecoder.decodeDouble(forKey: "collateral") : nil
				...
				price = aDecoder.containsValue(forKey: "price") ? aDecoder.decodeDouble(forKey: "price") : nil
				reward = aDecoder.containsValue(forKey: "reward") ? aDecoder.decodeDouble(forKey: "reward") : nil
		...
		@objc(ESIContractsGetCorporationsCorporationIDContractsOk) public class GetCorporationsCorporationIDContractsOk: NSObject, NSSecureCoding, NSCopying, JSONCoding {
			
			public enum GetCorporationsCorporationIDContractsStatus: String, JSONCoding, HTTPQueryable {
				case cancelled = "cancelled"
				case deleted = "deleted"
				case failed = "failed"
				case finished = "finished"
				...
				public init(json: Any) throws {
					guard let s = json as? String, let v = GetCorporationsCorporationIDContractsStatus(rawValue: s) else {throw ESIError.invalidFormat(Swift.type(of: self), json)}
					self = v
				}
			...
			public enum GetCorporationsCorporationIDContractsType: String, JSONCoding, HTTPQueryable {
				case auction = "auction"
				case courier = "courier"
				case itemExchange = "item_exchange"
				case loan = "loan"
				...
				public init(json: Any) throws {
					guard let s = json as? String, let v = GetCorporationsCorporationIDContractsType(rawValue: s) else {throw ESIError.invalidFormat(Swift.type(of: self), json)}
					self = v
				}
			...
			public enum GetCorporationsCorporationIDContractsAvailability: String, JSONCoding, HTTPQueryable {
				case alliance = "alliance"
				case corporation = "corporation"
				case personal = "personal"
				case `public` = "public"
				...
				public init(json: Any) throws {
					guard let s = json as? String, let v = GetCorporationsCorporationIDContractsAvailability(rawValue: s) else {throw ESIError.invalidFormat(Swift.type(of: self), json)}
					self = v
				}
			...
			public var acceptorID: Int = Int()
			public var assigneeID: Int = Int()
			public var availability: Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsAvailability = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsAvailability()
			public var buyout: Double? = nil
			public var collateral: Double? = nil
			public var contractID: Int = Int()
			public var dateAccepted: Date? = nil
			...
			public var reward: Double? = nil
			public var startLocationID: Int64? = nil
			public var status: Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsStatus = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsStatus()
			public var title: String? = nil
			public var type: Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsType = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsType()
			public var volume: Float? = nil
			...
			public required init(json: Any) throws {
				...
				guard let assigneeID = dictionary["assignee_id"] as? Int else {throw ESIError.invalidFormat(Swift.type(of: self), dictionary)}
				self.assigneeID = assigneeID
				guard let availability = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsAvailability(rawValue: dictionary["availability"] as? String ?? "") else {throw ESIError.invalidFormat(Swift.type(of: self), dictionary)}
				self.availability = availability
				buyout = dictionary["buyout"] as? Double
				collateral = dictionary["collateral"] as? Double
				guard let contractID = dictionary["contract_id"] as? Int else {throw ESIError.invalidFormat(Swift.type(of: self), dictionary)}
				...
				reward = dictionary["reward"] as? Double
				startLocationID = dictionary["start_location_id"] as? Int64
				guard let status = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsStatus(rawValue: dictionary["status"] as? String ?? "") else {throw ESIError.invalidFormat(Swift.type(of: self), dictionary)}
				self.status = status
				title = dictionary["title"] as? String
				guard let type = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsType(rawValue: dictionary["type"] as? String ?? "") else {throw ESIError.invalidFormat(Swift.type(of: self), dictionary)}
				self.type = type
				volume = dictionary["volume"] as? Float
			...
			public required init?(coder aDecoder: NSCoder) {
				acceptorID = aDecoder.decodeInteger(forKey: "acceptor_id")
				assigneeID = aDecoder.decodeInteger(forKey: "assignee_id")
				availability = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsAvailability(rawValue: aDecoder.decodeObject(forKey: "availability") as? String ?? "") ?? Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsAvailability()
				buyout = aDecoder.containsValue(forKey: "buyout") ? aDecoder.decodeDouble(forKey: "buyout") : nil
				collateral = aDecoder.containsValue(forKey: "collateral") ? aDecoder.decodeDouble(forKey: "collateral") : nil
				contractID = aDecoder.decodeInteger(forKey: "contract_id")
				dateAccepted = aDecoder.decodeObject(forKey: "date_accepted") as? Date
				...
				reward = aDecoder.containsValue(forKey: "reward") ? aDecoder.decodeDouble(forKey: "reward") : nil
				startLocationID = aDecoder.containsValue(forKey: "start_location_id") ? aDecoder.decodeInt64(forKey: "start_location_id") : nil
				status = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsStatus(rawValue: aDecoder.decodeObject(forKey: "status") as? String ?? "") ?? Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsStatus()
				title = aDecoder.decodeObject(forKey: "title") as? String
				type = Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsType(rawValue: aDecoder.decodeObject(forKey: "type") as? String ?? "") ?? Contracts.GetCorporationsCorporationIDContractsOk.GetCorporationsCorporationIDContractsType()
				volume = aDecoder.containsValue(forKey: "volume") ? aDecoder.decodeFloat(forKey: "volume") : nil
			...
			init(_ other: Contracts.GetCorporationsCorporationIDContractsOk) {
				acceptorID = other.acceptorID
				assigneeID = other.assigneeID
				availability = other.availability
				buyout = other.buyout
			...
			public func copy(with zone: NSZone? = nil) -> Any {
				return Contracts.GetCorporationsCorporationIDContractsOk(self)
			}
			
			
			public override func isEqual(_ object: Any?) -> Bool {
				return (object as? GetCorporationsCorporationIDContractsOk)?.hashValue == hashValue
			}
			
		}
		
		
		@objc(ESIContractsGetCorporationsCorporationIDContractsContractIDBidsOk) public class GetCorporationsCorporationIDContractsContractIDBidsOk: NSObject, NSSecureCoding, NSCopying, JSONCoding {
			...
			init(_ other: Contracts.GetCorporationsCorporationIDContractsContractIDBidsOk) {
				amount = other.amount
				bidID = other.bidID
				bidderID = other.bidderID
				dateBid = other.dateBid
			...
			public func copy(with zone: NSZone? = nil) -> Any {
				return Contracts.GetCorporationsCorporationIDContractsContractIDBidsOk(self)
			}
			
			
			public override func isEqual(_ object: Any?) -> Bool {
				return (object as? GetCorporationsCorporationIDContractsContractIDBidsOk)?.hashValue == hashValue
			}
			
		}
		
		
		@objc(ESIContractsGetCorporationsCorporationIDContractsContractIDItemsOk) public class GetCorporationsCorporationIDContractsContractIDItemsOk: NSObject, NSSecureCoding, NSCopying, JSONCoding {
			...
			init(_ other: Contracts.GetCorporationsCorporationIDContractsContractIDItemsOk) {
				isIncluded = other.isIncluded
				isSingleton = other.isSingleton
				quantity = other.quantity
				rawQuantity = other.rawQuantity
			...
			public func copy(with zone: NSZone? = nil) -> Any {
				return Contracts.GetCorporationsCorporationIDContractsContractIDItemsOk(self)
			}
			
			
			public override func isEqual(_ object: Any?) -> Bool {
				return (object as? GetCorporationsCorporationIDContractsContractIDItemsOk)?.hashValue == hashValue
			}
