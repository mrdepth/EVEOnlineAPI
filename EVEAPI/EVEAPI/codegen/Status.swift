...
public extension ESI {
	...
	class Status {
		...
		public class GetStatusInternalServerError: NSObject, NSSecureCoding, NSCopying, JSONCoding {
			...
			public static func ==(lhs: Status.GetStatusInternalServerError, rhs: Status.GetStatusInternalServerError) -> Bool {
				return lhs.hashValue == rhs.hashValue
			}
			
			init(_ other: Status.GetStatusInternalServerError) {
				error = other.error
			}
			
			public func copy(with zone: NSZone? = nil) -> Any {
				return Status.GetStatusInternalServerError(self)
			}
			
			
			public override func isEqual(_ object: Any?) -> Bool {
				return (object as? GetStatusInternalServerError)?.hashValue == hashValue
			}
