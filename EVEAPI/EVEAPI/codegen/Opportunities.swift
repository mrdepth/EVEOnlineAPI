	...
	public struct Opportunities {
		...
		public struct Groups {
			...
			public struct GroupID {
				...
				public func get(language: ESI.Universe.Language? = nil, cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, progress: Request.ProgressHandler? = nil) -> AnyPublisher<ESIResponse<ESI.Opportunities.Groups.GroupID.Success>, AFError> {
					do {
