	...
	class Char {
		...
		public class Notifications: NSObject, NSSecureCoding, NSCopying, JSONCoding {
			...
			public class Notification: NSObject, NSSecureCoding, NSCopying, JSONCoding {
				...
				public func encode(with aCoder: NSCoder) {
					...
					aCoder.encode(senderName, forKey: "senderName")
					aCoder.encode(sentDate, forKey: "sentDate")
					aCoder.encode(type.rawValue, forKey: "NotificationType")
				}
		...
		public class WalletJournal: NSObject, NSSecureCoding, NSCopying, JSONCoding {
			...
			public class Transaction: NSObject, NSSecureCoding, NSCopying, JSONCoding {
				...
				public var taxAmount: Double = Double()
				public var taxReceiverID: Int64 = Int64()
				...
				public required init(json: Any) throws {
					...
					guard let taxAmount = dictionary["taxAmount"] as? Double else {throw EVEError.invalidFormat(type(of: self), dictionary)}
					self.taxAmount = taxAmount
					guard let taxReceiverID = dictionary["taxReceiverID"] as? Int64 else {throw EVEError.invalidFormat(type(of: self), dictionary)}
				...
				public required init?(coder aDecoder: NSCoder) {
					...
					taxAmount = aDecoder.decodeDouble(forKey: "taxAmount")
					taxReceiverID = aDecoder.decodeInt64(forKey: "taxReceiverID")
				...
				public func encode(with aCoder: NSCoder) {
					...
					aCoder.encode(taxReceiverID, forKey: "taxReceiverID")
				}
				...
				public var json: Any {
					...
					json["taxAmount"] = taxAmount.json
					json["taxReceiverID"] = taxReceiverID.json
					return json
				}
				...
				override public var hashValue: Int {
					...
					hashCombine(seed: &hash, value: taxAmount.hashValue)
					hashCombine(seed: &hash, value: taxReceiverID.hashValue)
					return hash
				}
